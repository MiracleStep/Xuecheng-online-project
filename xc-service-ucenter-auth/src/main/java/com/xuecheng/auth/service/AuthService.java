...
public class AuthService {
    ...
    private boolean saveToken(String access_token,String content,long ttl){
        ...
        redisTemplate.opsForValue().set(key,content,ttl,TimeUnit.SECONDS);
    ...
    private AuthToken applyToken(String username, String password, String clientId, String clientSecret){
        ...
        header.add("Authorization",httpBasic);//添加Authorization中Basic Auth认证到header信息中
        ...
        authToken.setJwt_token((String) bodyMap.get("access_token"));//刷新令牌
